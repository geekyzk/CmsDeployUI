...
export const constantRoutes = [
...

  {
    path: '/template',
    component: Layout,
    redirect: '/template/templagePage',
    name: '模版管理',
    ...
    children: [
      {
        path: 'templatePage',
        name: '模版设置',
        component: () => import('@/views/template/TemplatePage'),
        meta: { title: '模版设置', icon: 'table' }
      },
      {
        path: 'tree',
        name: 'Tree',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'column',
        name: '栏目管理',
        component: () => import('@/views/site/SiteColumn'),
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'menu',
        name: '菜单设置',
        component: () => import('@/views/system/SystemMainMenu'),
